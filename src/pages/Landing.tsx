      ...
      <div className="text-center z-10 px-4 max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-center mb-8">
          ...
          <div className="text-left">
            <h1 className="text-2xl font-bold text-white">SafeGuard Portal</h1>
            <p className="text-blue-200">Chandigarh Police Initiative</p>
          </div>
        </div>

        {/* Typewriter Text */}
        <div className="mb-12">
          <h2 className="text-4xl md:text-6xl font-bold text-white min-h-[4rem] md:min-h-[6rem]">
            {displayedText}
        ...
        <Link 
          to="/auth" 
          className="inline-flex items-center space-x-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-12 py-6 rounded-2xl font-bold text-xl hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 transition-all duration-300 shadow-2xl"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <div className="text-center">
            ...
            <div className="text-blue-200">Cases Resolved</div>
          </div>
          <div className="text-center">
